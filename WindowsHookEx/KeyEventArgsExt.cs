...
namespace WindowsHookEx
{
    ...
    public class KeyEventArgsExt : KeyEventArgs
    {
        ...
        internal KeyEventArgsExt(Keys keyData, int scanCode, int timestamp, bool isKeyDown, bool isKeyUp,
            bool isExtendedKey, bool isInjectedKey)
            : this(keyData)
        {
            ScanCode = scanCode;
            Timestamp = timestamp;
        ...
        internal static KeyEventArgsExt FromRawDataApp(CallbackData data)
        {
            ...
            return new KeyEventArgsExt(keyData, scanCode, timestamp, isKeyDown, isKeyUp, isExtendedKey, isInjectedKey);
        }
