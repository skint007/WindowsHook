...
namespace WindowsHookEx
{
    ...
    public class MouseEventExtArgs : MouseEventArgs
    {
        ...
        /// <param name="isInjected">True if event was injected into the sytem.</param>
        internal MouseEventExtArgs(MouseButtons buttons, int clicks, Point point, int delta, int timestamp,
            bool isMouseButtonDown, bool isMouseButtonUp, bool isInjected)
        ...
        private static MouseEventExtArgs FromRawDataUniversal(IntPtr wParam, MouseStruct mouseInfo)
        {
            ...
            var isInjected = (mouseInfo.Flags & maskInjected) > 0;
        ...
        {
            return new MouseEventExtArgs(Button, 2, Point, Delta, Timestamp, IsMouseButtonDown, IsMouseButtonUp, false);
        }
    }
}