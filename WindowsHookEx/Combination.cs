...
namespace WindowsHookEx
{
    ...
    public class Combination
    {
        ...
        private Combination(Keys triggerKey, IEnumerable<Keys> chordKey)
            : this(triggerKey, new Chord(chordKey))
        {
        }
        ...
        /// <summary>
        ///     Key which all must be alredy down when trigger key is pressed.
        /// </summary>
